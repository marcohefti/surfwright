...
- generatedAt: `2026-02-23T14:10:08.724Z`
- iterations: `13`
...
| 12 | 1 | exp-08 | improved | 0/1 | 48410 | 31773 | 134 | -0.4% | -31.1% | Hard-failing headed mode in the bench shim plus successful-only headed guard scoring should eliminate false guard failures and stabilize iteration completion. | Bench headless wrapper now rejects headed mode pre-launch and scoring counts only successful headed executions for guard checks. | wallMs -14350ms; tokens -215; toolCalls -22 |
| 13 | 3 | exp-09 | regressed | 2/3 | 894108 | 1535720 | 2292 | +1746.9% | +4733.4% | Combining run-level correctness gates (plan.require), delta-based repeat-until, and relative scroll-plan steps should preserve low token/tool cost while recovering chunk>=2 validity. | Added plan.require assertions (including gte), repeat-until untilDeltaGte, and scroll-plan relative mode across CLI/pipeline/runtime guidance and tests. | wallMs +1503947ms; tokens +845698; toolCalls +2158 |

## Latest Snapshot

- iteration: `#13` (exp-09)
- agentsPerMission: `3`
- flowIds: `surfwright,surfwright-a2,surfwright-a3`
- outcome: `regressed`
- verified: `2/3`
- tokens: `894108`
- wall ms: `1535720`
...
- run state: `tmp/zerocontext/bench-loop/surfwright-benchmark-loop/mission-018-infinite-scroll-chunks/20260223T135534Z-i013/zcl-out/campaigns/surfwright-benchmark-loop-mission-018-infinite-scroll-chunks-i013-20260223t135534z-i013/campaign.run.state.json`
- metrics: `tmp/zerocontext/bench-loop/surfwright-benchmark-loop/mission-018-infinite-scroll-chunks/20260223T135534Z-i013/report/metrics.full.json`
