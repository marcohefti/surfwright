...
- `spawnUrl is non-empty and spawnTitle is non-empty and pageUrl == "https://the-internet.herokuapp.com/windows/new" and pageTitle == "New Window" and pageH3 == "New Window"`

## Example Proof Payload

```json
{
  "spawnUrl": "https://the-internet.herokuapp.com/windows",
  "spawnTitle": "The Internet",
