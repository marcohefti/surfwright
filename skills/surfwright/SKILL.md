...
- Do not retry target/query failures (`E_TARGET_ID_INVALID`, `E_TARGET_NOT_FOUND`, `E_TARGET_SESSION_UNKNOWN`, `E_TARGET_SESSION_MISMATCH`, `E_QUERY_INVALID`, `E_SELECTOR_INVALID`) until command inputs change.
