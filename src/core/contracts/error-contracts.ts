...
export const errorContracts: CliErrorContract[] = [
  ...
  { code: "E_STATE_READ_INVALID", message: "State file is invalid and was quarantined", retryable: false },
  { code: "E_STATE_VERSION_MISMATCH", message: "State file version is unsupported and was quarantined", retryable: false },
  { code: "E_STATE_READ_FAILED", message: "State file could not be read", retryable: true },
