...
import { ensureValidSelector, readPageTargetId, resolveSessionForAction, resolveTargetHandle, sanitizeTargetId } from "./targets.js";
...
export async function targetFill(opts: {
  ...
  try {
    ...
    await selected.locator.fill(value, {
      timeout: opts.timeoutMs,
    });
